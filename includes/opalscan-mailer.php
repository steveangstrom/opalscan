    ...
    if ( isset($_REQUEST) ) {
      ...
      if ( ! check_ajax_referer( 'opalscan-security-nonce', 'security' ) ) {
        ...
        if ( $mailaction == 'sendmail' ) {
          ...
          $message .= "<p $p_css>Just like offices all proffesional sites need maintenance and security to keep things in tip top condition. You've engaged us to take a quick no-cost & no-obligation assesment of your needs. You wouldn't leave your office door unlocked, or your premises in disrepair - your website needs the same care to keep it safe, secure and speedy.</p>";
